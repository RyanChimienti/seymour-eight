import SeymourEight.Cases.BSevenKThree.RSeven.XFourNoRoot.Labels
import SeymourEight.Cases.BSevenKThree.RSeven.XFourNoRoot.Encoding
...
namespace SeymourEight.BSevenKThree.RSeven.XFourNoRoot.GraphFacts
...
theorem coreArc_graphBits {zCount : Nat} (C : G.LocalConfiguration)
      ...
      · by_cases ht0 : target = 0
        · subst target
          ...
          · have hsx : source - 4 < 4 := by omega
            ...
            conv_lhs => rw [heqs]
            rw [SeymourEight.BSevenKThree.RSeven.XFourNoRoot.Encoding.xToAOne_coreBits
  ...
  · have hsP : source < 15 := hs
    ...
    · rw [if_pos htA]
      ...
      · rw [if_neg ht0,
          SeymourEight.BSevenKThree.RSeven.XFourNoRoot.Encoding.pToH_coreBits
    ...
    · rw [if_neg htA]
      ...
      · rw [if_neg htP, if_pos ht,
          SeymourEight.BSevenKThree.RSeven.XFourNoRoot.Encoding.pToZ_coreBits
...
theorem pHOut_toNat {zCount : Nat} (C : G.LocalConfiguration)
    (L : Labels G zCount C)
    (_hG : G.IsOriented) (hHCard : C.H.card = 7)
...
theorem pZOut_toNat {zCount : Nat} (C : G.LocalConfiguration)
    (L : Labels G zCount C) (_hG : G.IsOriented) (hzLe : zCount ≤ 5)
    (source : Nat) (hs : source < 7) :
...
end SeymourEight.BSevenKThree.RSeven.XFourNoRoot.GraphFacts

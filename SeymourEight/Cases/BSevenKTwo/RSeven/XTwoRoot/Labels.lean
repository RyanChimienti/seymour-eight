...
noncomputable def canonicalLabels (zCount : Nat) (C : G.LocalConfiguration)
  ...
  let eZ0 : Fin zCount ≃ {v : V // v ∈ (externalTargets G C)} :=
...
end SeymourEight.BSevenKTwo.RSeven.XTwoRoot.Labels
